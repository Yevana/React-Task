...
const AddPartner2 = () => {
    ...
    const submitHandler = () => {
        ...
        if (id != "" &&  active != "" && service.price != "" && service.commision != "") {
    ...
    return (
        <>
        {console.log(service.price,service.commision,success)}
                ...
                <div className="col-lg-8 page_reducer">
                    ...
                    <div className="ap_step2_02">
                        ...
                        {packages && packages.map((data,index) =>
                            <div className="row" style={{ padding: "10px 0", borderBottom: "2px solid #9999997c" }} key={index}>
                                <div className="col-lg-6">
                                ...
                                <div className="col-lg-3">
                                    <div className="d-flex align-items-center mt-2">
                                        ₹<input className="step2_input" style={{ color: "#999999", fontSize: "15px" }} onChange={inputEvent} name="price" type="number"/>
                                        <img src={pencil} alt="edit" width="15px" height="15px" className="ml-4" />
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="d-flex align-items-center mt-2">
                                        ₹<input className="step2_input" style={{ color: "#999999", fontSize: "15px" }} onChange={inputEvent} name="commision" type="number" />
                                        <img src={pencil} alt="edit" width="15px" height="15px" className="ml-4" />
                                    </div>
                                </div>
                            </div>
