...
export const getAllGarages = (actionData) => async (dispatch) => {
    ...
    const { data } = await axios.post('https://www.mastergarage.in/garageapi/admin/all-garages.php', actionData, config)
    if (!data) {
        dispatch({
...
export const addStep1 = (actionData) => async (dispatch) => {
    ...
    const { data } = await axios.post('https://www.mastergarage.in/garageapi/admin/offers.php', actionData, config)
    console.log(data);
    if (!data) {
        dispatch({
...
//     const { response } = await axios.post('https://www.mastergarage.in/garageapi/admin/offers.php', actionData, config)
...
export const getService = (id) => async (dispatch) => {
    ...
    const { data } = await axios.post(`https://www.mastergarage.in/garageapi/user/getServiceList.php?serviceType=${id}`, config)
...
export const getPackage = (id) => async (dispatch) => {
    ...
    const { data } = await axios.post(`https://www.mastergarage.in/garageapi/user/getServicePackage.php?serviceId=${id}`, config)
    console.log(data)
    if (!data) {
        dispatch({
...
//         const { data } = await axios.get('https://www.mastergarage.in/garageapi/admin/getAllSteps.php',config)
//         console.log(data)
